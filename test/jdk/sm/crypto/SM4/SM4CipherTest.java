...
public class SM4CipherTest {
    ...
    public void testKATWithByteBuffer() throws Exception {
        ...
        assertArrayEquals(expectedCiphertext, ciphertext.array());
        ...
        assertArrayEquals(message, cleartext.array());
    ...
    public void testEmpty() throws Exception {
        ...
        byte[] cleartext = cipher.doFinal(ciphertext);
        assertArrayEquals(EMPTY, cleartext);
    }
    ...
    public void testGCMModeWithByteBuffer() throws Exception {
        ...
        assertArrayEquals(MESSAGE, cleartextBuf.array());
    }
    ...
    private void testReuse(String algorithm,
        ...
        assertArrayEquals(message2, cleartext2);
    }
    ...
    private void testCipherStream(String algorithm,
        ...
        assertArrayEquals(cleartext, MESSAGE);
    }

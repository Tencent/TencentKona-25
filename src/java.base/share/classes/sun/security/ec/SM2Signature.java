...
public final class SM2Signature extends SignatureSpi {
    ...
    protected void engineInitSign(PrivateKey privateKey, SecureRandom random)
        ...
        if (pubPoint == null) {
            pubPoint = toECPoint(SM2OPS.multiply(
                    GENERATOR, toByteArrayLE(s)).asAffine());
        } else {
    ...
    protected byte[] engineSign() throws SignatureException {
        ...
        do {
            ...
            do {
                ...
                // A5
                r = e.add(toECPoint(p.asAffine()).getAffineX()).mod(ORDER);
    ...
    protected boolean engineVerify(byte[] sigBytes) throws SignatureException {
        ...
        MutablePoint p2 = SM2OPS.multiply(pubPoint, toByteArrayLE(t));
        SM2OPS.setSum(p, p2);
        if (isInfinitePoint(p.asAffine())) {
            return false;
        }
        ECPoint point = toECPoint(p.asAffine());
